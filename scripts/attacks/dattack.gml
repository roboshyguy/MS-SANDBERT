...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, bow_vfx_small);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, bow_vfx_big);
