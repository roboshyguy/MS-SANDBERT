...
//endlag
set_window_value(AT_NAIR, 11, AG_WINDOW_LENGTH, 14);
...
set_hitbox_value(AT_NAIR, 17, HG_DAMAGE, 3);
...
set_hitbox_value(AT_NAIR, 18, HG_DAMAGE, 3);
...
set_hitbox_value(AT_NAIR, 19, HG_DAMAGE, 3);
...
set_hitbox_value(AT_NAIR, 21, HG_DAMAGE, 4);
set_hitbox_value(AT_NAIR, 21, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 21, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_NAIR, 21, HG_KNOCKBACK_SCALING, 0.8);
