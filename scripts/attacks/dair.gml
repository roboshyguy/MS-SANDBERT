...
set_window_value(AT_DAIR, 7, AG_WINDOW_ANIM_FRAME_START, 13);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, bow_vfx_small);
...
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT, 197);
