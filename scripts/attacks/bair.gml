...
set_window_value(AT_BAIR, 4, AG_WINDOW_LENGTH, 22);
set_window_value(AT_BAIR, 4, AG_WINDOW_ANIM_FRAMES, 11);
set_window_value(AT_BAIR, 4, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(AT_BAIR, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX, asset_get("sfx_sand_yell"));
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX_FRAME, 4);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, bow_vfx_small);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, bow_vfx_small);
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -125);
...
set_hitbox_value(AT_BAIR, 3, HG_BASE_HITPAUSE, 15);
set_hitbox_value(AT_BAIR, 3, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, bow_vfx_big);
