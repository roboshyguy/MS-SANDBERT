...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX_FRAME, 6);
...
//startup (transition)
set_window_value(AT_DTILT, 6, AG_WINDOW_LENGTH, 7);
...
//startup2
set_window_value(AT_DTILT, 7, AG_WINDOW_LENGTH, 7);
...
set_window_value(AT_DTILT, 7, AG_WINDOW_SFX_FRAME, 6);
