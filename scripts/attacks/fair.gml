...
set_window_value(atk, window_num, AG_WINDOW_HSPEED, 9.2);
set_window_value(atk, window_num, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(atk, window_num, AG_WINDOW_VSPEED, 0.2);
...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_X, 49);
...
set_hitbox_value(atk, hitbox_num, HG_VISUAL_EFFECT, bow_vfx_small);
